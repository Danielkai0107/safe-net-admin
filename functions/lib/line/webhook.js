...
async function handlePostback(event, matchedTenant) {
    ...
    try {
        ...
        if ((alertData === null || alertData === void 0 ? void 0 : alertData.assignedTo) !== appUserId) {
            console.log("User is not the assigned person:", {
                assignedTo: alertData === null || alertData === void 0 ? void 0 : alertData.assignedTo,
                appUserId,
            });
            if (channelAccessToken) {
        ...
        if ((alertData === null || alertData === void 0 ? void 0 : alertData.assignmentStatus) !== "PENDING") {
            console.log("Alert already processed:", {
                alertId,
                status: alertData === null || alertData === void 0 ? void 0 : alertData.assignmentStatus,
            });
            ...
            if (channelAccessToken) {
                await (0, sendMessage_1.sendNotification)(lineUserId, channelAccessToken, statusMessages[(alertData === null || alertData === void 0 ? void 0 : alertData.assignmentStatus) || ""] ||
                    "⚠️ 此警報已被處理，無法再次操作。");
            }
            return;
        }
